...
def execute():
    ...
    # last_msg = mdb.find_user(senderID)
...
# TODO: Add the following statement if data['type'] == 'image' and user_tag == "KC":
        ...
        # user_id = at.get_field(senderID, "Farmer Name")
        ...
        public_link = utils.saveImageToCloudinary(sent_image,senderID)
        print(public_link)
        # file_id = gd.upload_image_v2("filename.jpg", sent_image)
        # public_link = gd.generate_public_link(file_id)
        mdb.update_cloudinary_images(senderID,'cloudinary_images',public_link)
...
#     last_msg = mdb.db['user'].find_one({'phoneNumber':918355882259})['user_tag']
#     print("last_msg ", last_msg)
